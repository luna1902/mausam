<script lang="ts">
	export let sunrise: string;
	export let sunset: string;
</script>

<div
	class="relative order-3 flex h-48 flex-col justify-between rounded-xl border bg-card p-4 text-card-foreground shadow-sm md:p-6 lg:order-2"
>
