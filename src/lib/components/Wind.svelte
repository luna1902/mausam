<script lang="ts">
	...
	export let deg: number;
</script>

<div
	class="relative order-4 h-48 rounded-xl border bg-card p-4 text-card-foreground shadow-sm md:p-6 xl:order-3"
>
	...
	<div class="flex justify-center p-0 font-semibold md:text-lg">
		<div
			class="relative -mt-5 flex h-[10rem] w-[10rem] items-center justify-center md:-mt-5 md:h-[9rem] md:w-[9rem]"
		>
			<div class="absolute text-sm font-semibold">
				{Math.round((speed * 1000.0) / 3600)}m/s
			</div>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 331 331" class="absolute dark:invert">
				<g fill="none" fill-rule="evenodd" opacity=".401">
					<path fill="#000" d="M11.5 0 23 23H0z" transform="translate(154 31)" />
					<path
						stroke="#000"
					...
					<g fill="#000" font-family="Arial-BoldMT, Arial" font-size={36} font-weight="bold">
						<text transform="translate(60 60)">
							<tspan x="92.501" y={33}> N </tspan>
						</text>
						<text transform="translate(60 60)">
							<tspan x="178.494" y={118}> E </tspan>
						</text>
						<text transform="translate(60 60)">
							<tspan x="93.494" y={203}> S </tspan>
						</text>
						<text transform="translate(60 60)">
							<tspan x="3.511" y={118}> W </tspan>
						</text>
					</g>
				</g>
			</svg>
			<svg
				...
				class="absolute transition-transform ease-in-out will-change-transform dark:invert"
			>
				<path
