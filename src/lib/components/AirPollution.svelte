...
<div
	class="relative order-2 col-span-2 flex h-48 flex-col justify-between rounded-xl border bg-card p-4 text-card-foreground shadow-sm md:order-1 md:p-6"
>
	...
	<div class="mt-auto flex items-center pt-0 text-xs md:text-sm">
		<p>
			{weather.air_quality['us-epa-index'] == 1
				? 'Air quality is good.'
