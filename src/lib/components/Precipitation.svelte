...
<div
	class="relative order-6 flex h-48 flex-col justify-between rounded-xl border bg-card p-4 text-card-foreground shadow-sm md:p-6"
>
	...
	<div class="font-semibold md:text-lg">
		<p>
			{precipitation || 0}mm <br />in the last 3h
		</p>
	</div>
